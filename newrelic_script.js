...
;(() => {
    ...
    r = {
      ...
      1214: (e, t, r) => {
        ...
        function C(e) {
          ...
          return (
            !f.il || j[t.debugId]++ || ((j[t.debugId] = 1), c(t).inPlace(window.history, N, '-')), t
          )
        }
        var R = r(3239)
        const O = {},
  ...
  ;(i.m = r),
    ...
    (i.u = (e) =>
      ({ 111: 'nr-spa', 164: 'nr-spa-compressor', 433: 'nr-spa-recorder' }[e] + '-1.248.0.min.js')),
        ...
        constructor(e, t) {
          ...
          this.ee.on('fn-err', (e, t, n) => {
            this.abortHandler &&
              !this.#e.has(n) &&
              (this.#e.add(n),
              (0, T.p)('err', [this.#t(n), (0, j.z)()], void 0, r.D.jserrors, this.ee))
          }),
            this.ee.on('internal-error', (e) => {
              this.abortHandler &&
                (0, T.p)('ierr', [this.#t(e), (0, j.z)(), !0], void 0, r.D.jserrors, this.ee)
            }),
